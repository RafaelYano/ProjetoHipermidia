...
<title>Alterar Capacidades</title>
</head>
<body>
<div id="tudo">
<div id="navegacao">
...
<div id="conteudo2">
	<% 
		...
		if(a!=null){
			out.println("<form action=\"excluir.jsp\">");
			out.println("<p>nome: <input type=\"text\" name=\"nome\" readonly=\"true\" size=\"50\" value=\""+a.getNome()+"\"/></p>");				
			out.println("<p>descricao: <input type=\"text\" name=\"descricao\" readonly=\"true\" size=\"50\" value=\""+a.getDescricao()+"\"/></p>");
			out.println("<p>origem: <input type=\"text\" name=\"origem\" readonly=\"true\" size=\"50\" value=\""+a.getOrigem()+"\"/></p>");
			out.println("<p><input type=\"submit\" value=\"excluir\"/></p>");
			out.println("</form>");
		}else{
